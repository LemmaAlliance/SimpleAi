...
np.save('and_weights_input_hidden.npy', weights_input_hidden)
np.save('and_weights_hidden_output.npy', weights_hidden_output)
...
plt.grid(True)
plt.savefig('and_error_vs_epochs.png')
plt.show()
